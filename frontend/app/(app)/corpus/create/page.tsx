...
function CreateCorpusForm() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-[#F4EFE7]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Create Corpus</h1>
        <p className="text-sm text-[#9BA7B4] mt-1">Define a curated research domain with GenLayer-validated admission criteria.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="card space-y-5">
          <h2 className="text-sm font-semibold text-[#F4EFE7] uppercase tracking-wider font-mono">Identity</h2>
          <div>
            <label className="block text-sm text-[#9BA7B4] mb-1.5">Corpus Name *</label>
            <input className="input" placeholder="e.g. Industrial AI Fault Detection" value={form.name}
              onChange={(e) => setForm({ ...form, name: e.target.value })} required />
          </div>
          <div>
            <label className="block text-sm text-[#9BA7B4] mb-1.5">Description *</label>
            ...
            <p className="text-xs text-[#4a5568] mt-1">GenLayer validators will read this to assess paper relevance.</p>
          </div>
        </div>

        <div className="card space-y-5">
          <h2 className="text-sm font-semibold text-[#F4EFE7] uppercase tracking-wider font-mono">Topic Scope</h2>
        ...
        <div className="card space-y-5">
          <h2 className="text-sm font-semibold text-[#F4EFE7] uppercase tracking-wider font-mono">Quality Thresholds</h2>
          <div>
            <div className="flex justify-between mb-2">
              <label className="text-sm text-[#9BA7B4]">Minimum Relevance Score</label>
              <span className="text-sm font-mono text-[#D6A84F]">{form.min_relevance_score}/100</span>
            </div>
            ...
            <div className="flex justify-between text-xs text-[#4a5568] mt-1"><span>Permissive (0)</span><span>Strict (100)</span></div>
          </div>
          <div>
            <div className="flex justify-between mb-2">
              <label className="text-sm text-[#9BA7B4]">Minimum Quality Score</label>
              <span className="text-sm font-mono text-[#D6A84F]">{form.min_quality_score}/100</span>
            </div>
